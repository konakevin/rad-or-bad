...
const FIELDS: { key: keyof PersonalAnchors; label: string; placeholder: string; icon: string }[] = [
  {
    ...
    placeholder: "A rooftop at sunset, my grandma's kitchen, the beach at night...",
    icon: 'location',
  },
  {
    key: 'object',
    label: 'Some objects you love',
    placeholder: 'A vintage camera, my guitar, a worn book...',
    icon: 'cube',
  },
  {
    key: 'era',
    label: 'Eras you vibe with',
    placeholder: '80s synthwave, medieval, the future...',
    icon: 'time',
  },
  {
    key: 'dream_vibe',
    label: 'How should your dreams feel?',
    placeholder: 'Cozy and magical, epic but intimate...',
    icon: 'sparkles',
  },
];
    ...
    >
      ...
      >
        ...
        <Text style={s.subtitle}>
          These help your bot dream things that feel uniquely yours. Fill in at least one.
        </Text>
