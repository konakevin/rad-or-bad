-- Migration 071: Bot messages on nightly dreams
-- Each nightly dream gets a short, playful message from the Dream Bot.
-- Generated by a dedicated Haiku call with memory of recent dreams + wishes.

ALTER TABLE public.uploads
  ADD COLUMN IF NOT EXISTS bot_message text;

-- Recreate get_feed to include bot_message (Postgres can't change return types in-place)
